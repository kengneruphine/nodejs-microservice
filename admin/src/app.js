...
(0, typeorm_1.createConnection)().then(function (db) {
    ...
    amqp.connect('amqps://nstdyqpm:MjSGh-LE0c1ELs1J59Nmi62xu0ypgNz4@elk.rmq2.cloudamqp.com/nstdyqpm', function (error0, connection) {
        if (error0) {
            throw error0;
        }
        connection.createChannel(function (error1, channel) {
            ...
            app.use(cors({
                origin: ['http://localhost:3000', 'http://localhost:8080', 'http://localhost:4200'] // the different frontend app
            }));
            ...
            app.post('/api/products', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            result = _a.sent();
                            //send the product created to the main project using event
